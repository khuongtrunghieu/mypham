<?php
	...
	$list1 = $conn->query("SELECT * FROM spham where IdDM = '3'");
		// cho nay t viet
							...
							<div class="main">
								<div class="breadcrumbs">
									<ul>
										...
										<li>
											<span>/</span>
											<strong>Mỹ Phẩm Tẩy Trang</strong>
										</li>
									</ul>
								</div>
								...
								<div class="pages">
									...
									<div class="pager">              
											<div class="pages">
												...
												?>
													<li><a href="taytrang.php?trang=<?php echo $i?>"><?php echo $i?></a></li>
												<?php
													}
												?>				  
												</ul>
