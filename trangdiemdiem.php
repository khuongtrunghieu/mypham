<?php
	...
	$list1 = $conn->query("SELECT * FROM spham where IdDM = '2'");		
		// cho nay t viet
								...
								<div class="pager">              
										<div class="pages">
											...
											<?php
												...
												?>
													<li><a href="trangdiemdiem.php?trang=<?php echo $i?>"><?php echo $i?></a></li>
												<?php
													}
												?>					  
											</ul>
